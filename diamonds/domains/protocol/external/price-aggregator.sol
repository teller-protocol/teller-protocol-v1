    ...
    IPriceAggregator
{
    ...
    {
        return priceAggStore().supportedTokens[tokenAddress].array;
    }
     ...
     */
    function chainlinkAggregatorFor(address src, address dst)
        external
        view
        override
        returns (AggregatorV2V3Interface, bool)
    {
        ...
        return _chainlinkAggregatorFor(src, dst);
    }
        ...
        returns (bool)
    {
        ...
        return priceAggStore().supportedTokens[tokenAddress].array.length > 0;
    }
