...
function generateEscrowCloneAddressFromFactory(loansAddress, borrower, factoryAddress, libraryAddress) {
    const escrowCloneBytecode = getEscrowBytecodeFromAddress(libraryAddress);
    const salt = web3_utils.soliditySha3(loansAddress, borrower);
