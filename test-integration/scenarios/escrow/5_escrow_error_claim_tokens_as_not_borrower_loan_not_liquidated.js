...
module.exports = async (testContext) => {
  ...
  console.log(
    'Scenario: Escrow#5 - Error claim tokens as borrower and loan was liquidated'
  );
  ...
  await escrowActions.claimTokens(
    ...
    {
      recipient: lenderTxConfig.from,
      shouldFail: true,
      expectedRevertReason: 'Ownable: caller is not the owner',
    }
  );
