...
const _5_takeout_loan_invalid_debt_ratio = require('./5_takeout_loan_invalid_debt_ratio');
...
const _13_take_out_loan_to_user_wallet = require('./13_take_out_loan_to_user_wallet');
const _14_take_out_loan_to_escrow = require('./14_take_out_loan_to_escrow');
...
module.exports = {
  ...
  _5_takeout_loan_invalid_debt_ratio,
  ...
  _10_liquidate_loan_due_to_under_collateralized,
  _11_liquidate_loan_due_to_end_date,
  _12_liquidate_loan_invalid_liquidation_not_needed,
  _13_take_out_loan_to_user_wallet,
  _14_take_out_loan_to_escrow,
};
