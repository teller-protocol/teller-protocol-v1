...
module.exports = async (testContext) => {
  ...
  const initialSafetyIntervalSetting = await settingsActions.getPlatformSettings(allContracts, { testContext}, { settingName: platformSettingsNames.SafetyInterval });
