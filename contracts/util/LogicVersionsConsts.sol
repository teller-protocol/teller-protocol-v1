...
contract LogicVersionsConsts {
    ...
    bytes32 public constant TOKEN_COLLATERAL_LOANS_LOGIC_NAME = keccak256("TokenCollateralLoans");
    bytes32 public constant ETHER_COLLATERAL_LOANS_LOGIC_NAME = keccak256("EtherCollateralLoans");
    bytes32 public constant LOAN_TERMS_CONSENSUS_LOGIC_NAME = keccak256("LoanTermsConsensus");
    bytes32 public constant INTEREST_CONSENSUS_LOGIC_NAME = keccak256("InterestConsensus");
    ...
    bytes32
        public constant CHAINLINK_PAIR_AGGREGATOR_LOGIC_NAME = keccak256("ChainlinkPairAggregator");
    bytes32
        public constant CHAINLINK_PAIR_AGGREGATOR_REGISTRY_LOGIC_NAME = keccak256("ChainlinkPairAggregatorRegistry");
    bytes32 public constant SETTINGS_LOGIC_NAME = keccak256("Settings");
    bytes32 public constant LOGIC_VERSIONS_REGISTRY_LOGIC_NAME = keccak256("LogicVersionsRegistry");
