...
library TellerCommon {
    ...
    /**
        ...
        @param totalNotWithdrawn The total amount of accrued interest claimed, but not yet withdrwan by the lender
    ...
    /**
        ...
        @param consensusAddress The address of the Teller interest consensus contract to which the request is being submitted
        ...
        @param endTime The timestamp at which the interest accrual caluculation stops
    ...
    /**
        ...
        @param consensusAddress The wallet address of the signer submitted the interest response of the submitted request
        @param responseTime The timestamp at which the response was sent
        @param interest The signed amount of accured interest earned that is caluculated by the signer
    ...
    /**/
        ...
        @param consensusAddress The address of the Teller loan consensus contract to which the request should be sent
        @param responseTime The timestamp at which the response was sent
        @param interestRate The signed interest rate generated by the CRA
        @param collateralRatio The ratio of collateral to loan amount requested that is generated by the signer's CRA
    ...
    /**
        ...
        @param collateralRatio The consensus value for the he ratio of collateral to loan amount required for the loan, based on all the loan responses from the signers
    ...
    /**
        ...
        @param termsExpiry The timstamp at which the loan terms expire, after which if the loan is not yet active, cannot be taken out
    ...
    /**
        ...
        @param loans The address for the Teller lLans contract that is being used for a market
