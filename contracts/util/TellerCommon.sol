...
library TellerCommon {
    ...
    /**
        ...
        @param totalAccruedInterest Total amount of accrued interest for a lender
        @param totalNotWithdrawn The total amount of accrued interest claimed, but not yet withdrawn by the lender
        @param timeLastAccrued The timestamp at which accrued interest was last claimed by the lender
     */
    ...
    /**
        ...
        @param r The random point x-coordinate of the signature respresented by the first 32 bytes of the
    ...
    /**
        ...
        @param lender The wallet address of the associated lender
        @param consensusAddress The address of the Teller interest consensus contract to which the request
        is being submitted
        @param requestNonce Nonce of the lender address used for authentication
        @param startTime The timestamp at which the interest accrual is being requested to start
        @param endTime The timestamp at which the interest accrual calculation stops
        @param requestTime The timestamp at which the request is submitted by the lender
     */
    ...
    /**
        ...
        @param consensusAddress The wallet address of the signer who submitted the interest response of the
        submitted request
        @param responseTime The timestamp at which the response was sent
        @param interest The signed amount of accrued interest earned that is calculated by the signer
    ...
    /**
        ...
        @param collateralRatio The ratio of collateral to loan amount that is generated by the signer's
    ...
    /**
        ...
        @param collateralRatio The consensus value for the ratio of collateral to loan amount required for
        the loan, based on all the loan responses from the signers
        @param maxLoanAmount The consensus value for the largest amount of tokens that can be taken out in
        the loan, based on all the loan responses from the signers
     */
    ...
    /**
        ...
        @param collateralRatio The consensus ratio of collateral to loan amount calculated based on all
        signer loan responses
        @param maxLoanAmount The consensus largest amount of tokens that can be taken out in the loan by
        the borrower, calculated based on all signer loan responses
    ...
    /**
        ...
        @param termsExpiry The timestamp at which the loan terms expire, after which if the loan is not
        yet active, cannot be taken out
        ...
        @param escrow The address of the escrow contract that holds the funds taken out in the loan on
        behalf of the borrower
        @param status The status of the loan currently based on the LoanStatus enum - NonExistent,
        TermsSet, Active, Closed
    ...
    /**
        ...
        @dev If the loan does not need to be liquidated, amountToLiquidate is the maximum payment amount
        of lending tokens that will be required to liquidate the loan.
        @dev If the loan can be liquidated, amountToLiquidate is the current payment amount of lending
        tokens that is needed to liquidate the loan.
        @dev Liquidation reward is the value the liquidator will receive denoted in the collateral token.
        It will be, at maximum, the amount of collateral required. For under collateralized loans, the
        remaining value will be collected from tokens held by the loan's Escrow contract.
     */
    ...
    /**
        ...
        @param data The encoded function signature with parameters for the dapp method in bytes that will
        be sent in the Escrow delegatecall
     */
    struct DappData {
        address location;
        bytes data;
    ...
    /**
        ...
        @param loanTermsConsensus The address for the Teller Loan Terms Consensus contract that is being
        used for a market
