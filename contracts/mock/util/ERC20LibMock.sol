...
contract ERC20LibMock {
    ...
    function tokenTransferFrom(address tokenAddress, address from, uint256 amount) external {
        ERC20(tokenAddress).tokenTransferFrom(from, amount);
    }

    function tokenTransfer(address tokenAddress, address recipient, uint256 amount) external {
