...
contract PriceAggFacet {
     ...
     * @param src the source token address to check if it belongs to compound
     * @param dst the destination token address to check if it too belongs to compound
     * @return the calculated price from compound
     */
     ...
     * @param cRate compound rate used to calculate the value
