...
contract AssetSettings is AssetSettingsInterface, BaseUpgradeable {
  ...
  /**
     ...
     */
  bytes32 internal constant CTOKEN_ADDRESS_ASSET_SETTING = keccak256("CTokenAddress");

  /**
        @notice The asset setting name for yearn vault address settings.
     */
  bytes32 internal constant YEARN_VAULT_ADDRESS_ASSET_SETTING = keccak256("YVaultAddress");

  /**
        @notice The asset setting name for curve pool address settings.
     */
  bytes32 internal constant CRV_POOL_ADDRESS_ASSET_SETTING = keccak256("CRVPoolAddress");

  /**
        @notice The asset setting name for the maximum loan amount settings.
     */
  bytes32 internal constant MAX_LOAN_AMOUNT_ASSET_SETTING = keccak256("MaxLoanAmount");
