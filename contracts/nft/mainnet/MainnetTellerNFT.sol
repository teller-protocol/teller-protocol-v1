...
contract MainnetTellerNFT is IERC721ReceiverUpgradeable, TellerNFT_V2 {
    ...
    TellerNFTDictionary public constant DICT = TellerNFTDictionary(0x72733102AB139FB0367cc29D492c955A7c736079);
    ...
    function _convertV1TokenId(uint256 _tokenId) internal returns (uint256 tokenId_) {
