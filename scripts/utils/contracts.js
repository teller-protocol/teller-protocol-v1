...
const internalInterestConsensus = (
  collateralToken,
  tokenName,
...
const internalLoanTermsConsensus = (
  collateralToken,
  tokenName,
  artifactName = 'LoanTermsConsensus'
) => {
  return {
    keyName: TELLER_KEY,
...
const customCollateralToken = (collateralToken) => {
  ...
  const loansArtifactName =
    collToken === ETH ? 'EtherCollateralLoans' : 'TokenCollateralLoans';
  return {
    loans: (tokenName) => {
