...
module.exports = async (callback) => {
    try {
        ...
        console.log(`Initial:   ${initialReceiverBalance.toString()} = ${toUnits(initialReceiverBalance.toString(), tokenDecimals.toString())}`);
        console.log(`Final:     ${finalReceiverBalance.toString()} = ${toUnits(finalReceiverBalance.toString(), tokenDecimals.toString())}`);
