...
module.exports = async (callback) => {
  try {
    ...
    console.log(
      `${truffleCommand} --network ${processArgs.network()} --loanId ${loanID} --tokenName ${tokenName} --collTokenName ${collateralTokenName} --senderIndex ${senderIndex} --amount ${loanAmount}`
    );
