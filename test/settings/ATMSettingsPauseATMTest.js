  ...
  withData(
    {
      ...
      _4_platform_already_paused: [
        ...
        true,
        true,
        'PLATFORM_IS_ALREADY_PAUSED',
        true,
      ],
      _5_atm_already_paused: [
        [1, 2],
        2,
        1,
        true,
    ...
    function (
      ...
      it(
        t('user', 'pauseATM', 'Should (or not) be able to pause an ATM.', mustFail),
        async function () {
          // Setup
          ...
          try {
            ...
            atmSettings.atmPaused(result).emitted(atmAddress, sender);
          } catch (error) {
            // Assertions
            assert(mustFail);
            assert(error);
