  ...
  withData(
    {
      ...
      _6_atm_gov_empty: [
        ...
        true,
        false,
        'ATM_GOV_MUST_BE_CONTRACT',
        true,
      ],
      _7_atm_gov_not_contract: [
        [newAtM(5, 2, 0)],
        newAtM(2, 2, 99),
        0,
        true,
    ...
    function (
      ...
      it(
        t(
          'user',
          'setATMToMarket',
          'Should (or not) be able to set ATM to a market.',
          mustFail
        ),
        async function () {
          // Setup
          ...
          const atmAddress =
            atmToMarket.atmAddressIndex === -1
              ? NULL_ADDRESS
              : atmToMarket.atmAddressIndex === 99
              ? accounts[atmToMarket.collateralTokenIndex]
