/**
    See more details about the values for each settings in 'settingsValues.js' file relative to each network folder config/networks/NETWORK/settingsValues.js
 */
module.exports = {
