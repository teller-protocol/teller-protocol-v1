...
contract('AddressArrayLibTest', function (accounts) {
  ...
  withData(
    ...
    function (
      ...
      it(
        t('user', 'add', 'Should be able (or not) to add a new item.', mustFail),
        async function () {
          // Setup
  ...
  withData(
    ...
    function (
      ...
      it(
        t('user', 'remove', 'Should be able to remove an item.', mustFail),
        async function () {
          // Setup
          const addresses = mapIndexes(accounts, initialIndexesList);
          const expectedAddresses = mapIndexes(accounts, expectedIndexes);
  ...
  withData(
    ...
    function (
      ...
      it(
        t('user', 'removeAt', 'Should be able to remove a item at an index.', mustFail),
        async function () {
          // Setup
          const addresses = mapIndexes(accounts, initialIndexesList);
          const expectedAddresses = mapIndexes(accounts, expectedIndexes);
  ...
  withData(
    ...
    function (initialIndexesList, getItemIndex, expectedFound, expectedIndex) {
      it(
        t('user', 'getIndex', 'Should be able to get an index.', false),
        async function () {
          // Setup
          const addresses = mapIndexes(accounts, initialIndexesList);
