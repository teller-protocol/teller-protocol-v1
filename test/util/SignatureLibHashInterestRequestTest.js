...
contract('SignatureLibHashInterestRequestTest', function (accounts) {
    ...
    withData({
        _1_mainnet_test_hashInterestRequest: [chains.mainnet, accounts[2], 234764, 344673177, 34467317723],
        _2_ropsten_first_test_hashInterestRequest: [chains.ropsten, accounts[3], 134764, 354673177, 37467617723],
        _3_ropsten_second_test_hashInterestRequest: [chains.ropsten, NULL_ADDRESS, 0, 0, 0],
    }, function(
            chainId,
            lender,
            startTime,
    ...
    withData({
        _4_mainnet_test_hashInterestResponse: [chains.mainnet, accounts[0], 234764, 344673177, 34467317723],
        _5_ropsten_first_test_hashInterestResponse: [chains.ropsten, accounts[4], 765189, 344673177, 34657317723],
        _6_ropsten_second_test_hashInterestResponse: [chains.mainnet, NULL_ADDRESS, 0, 0, 0],
    }, function(
        chainId,
        signer,
        responseTime,
