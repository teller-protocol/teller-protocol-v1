  ...
  withData(
    {
      ...
      _3_emptySettingName: [
        ...
        EMPTY_SETTING_NAME,
        SETTING_VALUE,
        'GENERAL_SETTING_MUST_BE_PROVIDED',
        true,
      ],
      _4_emptySettingValue: [
        0,
        SETTING_NAME,
        EMPTY_SETTING_VALUE,
        'GENERAL_SETTING_MUST_BE_POSITIVE',
        true,
      ],
      _5_wrongNameFormat: [
        0,
    ...
    function (senderIndex, settingName, settingValue, expectedErrorMessage, mustFail) {
      it(
        t(
          'user',
          'addGeneralSetting#1',
          'Should (or not) be able to add a general setting.',
          mustFail
        ),
        async function () {
          // Setup
    ...
    function (senderIndex, settingName, settingValue, expectedErrorMessage, mustFail) {
      it(
        t(
          'user',
          'addGeneralSetting#2',
          'Should not be able to add a general setting twice.',
          mustFail
        ),
        async function () {
          // Setup
