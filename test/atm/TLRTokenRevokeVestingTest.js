  ...
  withData(
    {
      ...
      _2_revoke_vested_no_amount: [
        ...
        1750,
        7000,
        'ACCOUNT_DOESNT_HAVE_VESTING',
        true,
      ],
      _3_revoke_vested_invalid_sender: [
        false,
        daoMember1,
        daoMember2,
        1000,
    ...
    function (
      ...
      it(
        t('agent', 'revokeVesting', 'Should or be able to revoke correctly', mustFail),
        async function () {
          // Setup
          await instance.mintVesting(daoMember1, amount, cliff, vestingPeriod, {
            from: daoAgent,
          });
          ...
          try {
            ...
            tlrToken.revokeVesting(result).emitted(recipient, amount, deadline);
          } catch (error) {
            // Assertions
            assert(mustFail);
            assert(error);
