...
contract('EstimateGasTLRTokenWithdrawVestedTest', function (accounts) {
    ...
    const MAX_VESTINGS_PER_WALLET_SUPPORTED = 1718; // MAX amount of vestings in one transaction based on gas limit. We are using
                                                    // 1718 as test network gas limit is set to 6500000 and  
