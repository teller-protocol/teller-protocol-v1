  ...
  withData(
    ...
    function (
      ...
      it(
        t(
          'user',
          'updateDataProvider#1',
          'Should (or not) be able to update a data provider.',
          mustFail
        ),
        async function () {
          // Setup
          ...
          // Precondition
          await instance.addDataProvider(DATA_TYPE_INDEX, oldDataProvider, {
            from: validSender,
          });
          if (repeatProvider) {
          ...
          try {
            // Invocation
            const result = await instance.updateDataProvider(
              dataTypeIndex,
              dataProviderIndex,
              newDataProvider,
              { from: sender }
  ...
  withData(
    ...
    function (
      ...
      it(
        t(
          'user',
          'updateDataProvider#2',
          'Should not be able to update non-contract addresses as data providers.',
          mustFail
        ),
        async function () {
          // Setup
          ...
          const oldDataProvider = dataProviderContract.address;
          // Precondition
          await instance.addDataProvider(dataTypeIndex, oldDataProvider, {
            from: validSender,
          });
