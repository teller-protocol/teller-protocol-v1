  ...
  withData(
    {
      ...
      _3_emptySettingName: [
        ...
        EMPTY_SETTING_NAME,
        SETTING_VALUE,
        'ASSET_SETTING_MUST_BE_PROVIDED',
        true,
      ],
      _4_invalidSettingValue: [
        0,
        EMPTY_SETTING_NAME,
        INVALID_SETTING_VALUE,
        'ASSET_SETTING_MUST_BE_POSITIVE',
        true,
      ],
      _5_wrongNameFormat: [
        0,
    ...
    function (senderIndex, settingName, settingValue, expectedErrorMessage, mustFail) {
      it(
        t(
          'user',
          'addAssetMarketSetting#1',
          'Should (or not) be able to add an asset market setting.',
          mustFail
        ),
        async function () {
          // Setup
          ...
          try {
            // Invocation
            const result = await instance.addAssetMarketSetting(
              assetAddress,
              settingName,
              settingValue,
              {
            ...
            const aSettingValue = await instance.getAssetMarketSetting(
              assetAddress,
              settingName
            );
  ...
  withData(
    ...
    function (senderIndex, settingName, settingValue, expectedErrorMessage, mustFail) {
      it(
        t(
          'user',
          'addAssetMarketSetting#2',
          'Should not be able to add an asset market setting twice.',
          mustFail
        ),
        async function () {
          // Setup
          ...
          try {
            // Invocation
            const result1 = await instance.addAssetMarketSetting(
              assetAddress,
              settingName,
              settingValue,
              {
            ...
            assert(result1);
            const result2 = await instance.addAssetMarketSetting(
              assetAddress,
              settingName,
              settingValue,
              {
  ...
  withData(
    {
      _1_nullAsset: [
        ...
        SETTING_NAME,
        SETTING_VALUE,
        'ASSET_ADDRESS_IS_REQUIRED',
        true,
      ],
      _1_notContractAddress: [
        0,
        DUMMY_ADDRESS,
        SETTING_NAME,
        SETTING_VALUE,
        'ASSET_MUST_BE_A_CONTRACT',
        true,
      ],
    },
    function (
      ...
      it(
        t(
          'user',
          'addAssetMarketSetting#3',
          'Should not be able to add an asset market setting to a non-contract address.',
          mustFail
        ),
        async function () {
          // Setup
