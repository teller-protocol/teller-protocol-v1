...
contract("ATMLiquidityMiningStakeTest", function(accounts) {
    ...
    withData({
        _1_basic: [ ADMIN_INDEX, true, "TokenName", "TKN", 18, 1000, 20000, 3, undefined, false ],
        _2_notAdmin: [ 0, false, "TokenName", "TKN", 18, 1000, 20000, 400, true, "NOT_PAUSER" ],
    }, function(senderIndex, addAsPauserRole, name, symbol, decimals, cap, maxVesting, tlrReward, mustFail, expectedErrorMessage) {
