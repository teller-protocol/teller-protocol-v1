  ...
  withData(
    {
      ...
      _4_compound_redeem_error: [
        SIMULATE_COMPOUND_REDEEM_UNDERLYING_RETURN_ERROR,
        SIMULATE_COMPOUND_REDEEM_UNDERLYING_RETURN_ERROR,
        false,
        true,
        'COMPOUND_WITHDRAWAL_ERROR',
      ],
    },
    function (amount, balance, redeemAll, mustFail, expectedErrorMessage) {
      it(
        t(
          'escrow',
          'redeem',
          'Should be able (or not) to redeem tokens on Compound',
          mustFail
        ),
        async function () {
          // Setup
