  ...
  withData(
    {
      ...
      _3_collateral_ratio_109_99: ['10999', false],
      _4_collateral_ratio_110: ['11000', true],
      _5_collateral_ratio_110_01: ['11001', true],
      _6_collateral_ratio_116: ['11600', true],
      _7_collateral_ratio_130: ['13000', true],
      _8_collateral_ratio_150: ['15000', true],
      _9_collateral_ratio_160: ['16000', true],
    },
    function (collateralRatio, expectedResult) {
      it(
        t(
          'user',
          'isLoanOverCollateralized',
          'Should able to test whether a loan is considered to be secured.',
          false
        ),
        async function () {
          // Setup
