    ...
    function (
      ...
      it(
        t(
          'user',
          'isTToken',
          'Should able (or not) to call function with modifier isTToken.',
          mustFail
        ),
        async function () {
          // Setup
          ...
          try {
            ...
            assert(
              !mustFail,
              'It should have failed because the sender has no permissions.'
            );
            assert(result);
          } catch (error) {
            // Assertions
    ...
    function (
      ...
      it(
        t(
          'user',
          'isLendingPool',
          'Should able (or not) to call function with modifier isLendingPool.',
          mustFail
        ),
        async function () {
          // Setup
    ...
    function (
      ...
      it(
        t(
          'user',
          'isValid',
          'Should able (or not) to call function with modifier isValid.',
          mustFail
        ),
        async function () {
          // Setup
          ...
          try {
            ...
            assert(
              !mustFail,
              'It should have failed because the address is invalid/empty.'
            );
            assert(result);
          } catch (error) {
            // Assertions
