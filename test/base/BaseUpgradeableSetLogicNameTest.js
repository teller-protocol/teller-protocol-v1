  ...
  withData(
    {
      ...
      // _3_logic_name_not_present: [undefined, "LogicName3", false,  'LOGIC_NAME_NOT_EXIST', true], TODO: reimplement in new test suite
    },
    function (
      previousLogicName,
      logicName,
      ...
      it(
        t(
          "user",
          "setLogicName",
          "Should (or not) be able to set the logic name.",
          mustFail
        ),
        async function () {
          // Setup
