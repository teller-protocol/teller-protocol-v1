...
contract('EstimateGasLoanTermsConsensusProcessRequestTest', function (accounts) {
  ...
  let responseSix = createUnsignedLoanResponse(
    nodeSix,
    0,
    1400,
    6767,
  ...
  let responseSeven = createUnsignedLoanResponse(
    nodeSeven,
    0,
    1400,
    6767,
  ...
  let responseEight = createUnsignedLoanResponse(
    nodeEight,
    0,
    1400,
    6767,
  ...
  let responseNine = createUnsignedLoanResponse(
    nodeNine,
    0,
    1400,
    6767,
  ...
  before('Setup the response times and signatures', async () => {
    ...
    const requestHash = ethUtil.bufferToHex(
      hashLoanTermsRequest(loanRequest, loans.address, chainId)
    );
    ...
    responseSix = await createLoanResponseSig(
      web3,
      nodeSix,
      responseSix,
      requestHash,
    ...
    responseSeven = await createLoanResponseSig(
      web3,
      nodeSeven,
      responseSeven,
      requestHash,
    ...
    responseEight = await createLoanResponseSig(
      web3,
      nodeEight,
      responseEight,
      requestHash,
    ...
    responseNine = await createLoanResponseSig(
      web3,
      nodeNine,
      responseNine,
      requestHash,
  ...
  withData(
    {
      ...
      _3_response: [100, [responseOne, responseTwo, responseThree]],
      _4_responses: [320, [responseOne, responseTwo, responseThree, responseFour]],
      _5_responses: [
        250,
        [responseOne, responseTwo, responseThree, responseFour, responseFive],
      ],
      _6_responses: [
        320,
        [
    ...
    function (tolerance, responses) {
      it(
        t('user', 'new', 'Should accept/not accept a nodes response', false),
        async function () {
          // Setup
          ...
          assert(
            ...
            'Expected max gas less than result.'
          );
        }
      );
    }
