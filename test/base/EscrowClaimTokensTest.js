  ...
  withData(
    {
      ...
      _2_loan_not_liquidated_recipient_not_borrower: [
        loanStatus.Closed,
        accounts[1],
        accounts[2],
        false,
      ...
      _3_loan_not_liquidated_recipient_is_borrower: [
        loanStatus.Closed,
        accounts[1],
        accounts[1],
        false,
      ...
      _4_loan_liquidated_recipient_is_borrower: [
        loanStatus.Closed,
        accounts[1],
        accounts[1],
        true,
      ...
      _5_loan_liquidated_recipient_not_borrower: [
        loanStatus.Closed,
        accounts[1],
        accounts[2],
        true,
    ...
    function (
      ...
      it(
        t(
          'user',
          'claimTokens',
          'Should be able to claim tokens after the loan is closed.',
          mustFail
        ),
        async function () {
          // Setup
          ...
          try {
            ...
            escrow.tokensClaimed(result).emitted(borrower);
          } catch (error) {
