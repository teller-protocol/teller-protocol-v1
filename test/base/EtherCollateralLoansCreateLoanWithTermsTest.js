...
contract('EtherCollateralLoansCreateLoanWithTermsTest', function (accounts) {
  ...
  beforeEach('Setup for each test', async () => {
    ...
    processRequestEncoding = loanTermsConsTemplate.contract.methods
  ...
  withData(
    {
      ...
      _3_msg_value_collateral_param_not_match_1: [
        AMOUNT_LOAN_REQUEST,
        17,
        1,
        500000,
      ...
      _4_msg_value_collateral_param_not_match_2: [
        AMOUNT_LOAN_REQUEST,
        17,
        500000,
        0,
      ...
      _5_msg_value_collateral_param_not_match_3: [
        AMOUNT_LOAN_REQUEST,
        17,
        200000,
        200001,
      ...
      _6_no_msg_value_exceeds_max_amount: [
        AMOUNT_LOAN_REQUEST - 400,
        3,
        0,
        0,
      ...
      _7_with_msg_value_exceeds_max_amount: [
        AMOUNT_LOAN_REQUEST - 1,
        17,
        500000,
        500000,
        'AMOUNT_EXCEEDS_MAX_AMOUNT',
    ...
    function (
      ...
      it(
        t(
          'user',
          'createLoanWithTerms',
          'Should able (or not) to set loan terms.',
          mustFail
        ),
        async function () {
          const interestRate = Math.floor(
            (responseOne.interestRate + responseTwo.interestRate) / 2
          );
          const collateralRatio = Math.floor(
            (responseOne.collateralRatio + responseTwo.collateralRatio) / 2
          );
          const maxLoanAmount = Math.floor(
            (responseOne.maxLoanAmount + responseTwo.maxLoanAmount) / 2
          );
