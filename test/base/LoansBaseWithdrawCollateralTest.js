...
contract('LoansBaseWithdrawCollateralTest', function (accounts) {
  ...
  withData(
    ...
    function (
      ...
      it(
        t('user', 'withdrawCollateral', 'Should able to withdraw collateral.', false),
        async function () {
          // Setup
          ...
          try {
            ...
            const tx = await instance.withdrawCollateral(withdrawalAmount, mockLoanID, {
              from: msgSender,
            });
            ...
            loans.collateralWithdrawn(tx).emitted(mockLoanID, loanBorrower, paidOut);
