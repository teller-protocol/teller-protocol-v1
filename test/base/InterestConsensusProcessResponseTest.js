  ...
  withData(
    {
      ...
      _7_first_valid_submission_ropsten: [
        // mock the first valid submission
        chains.ropsten,
        20,
        4610,
    ...
    function (
      ...
      it(
        ...
        async function () {
          ...
          const interestRequest = createInterestRequest(
            lender,
            requestNonce,
            23456,
            endTime,
          ...
          const requestHash = ethUtil.bufferToHex(
            hashInterestRequest(interestRequest, lendersContract, chainId)
          );
          ...
          let interestResponse = createUnsignedInterestResponse(
            nodeAddress,
            responseTime,
            interest,
            signerNonce,
          ...
          interestResponse = await createInterestResponseSig(
            web3,
            nodeAddress,
            interestResponse,
            requestHash,
