...
const ChainlinkAggregator = artifacts.require(
  './providers/chainlink/ChainlinkAggregator'
);
  ...
  withData(
    {
      ...
      _3_terms_set_with_more_collateral_required: [
        TERMS_SET,
        10000,
        100,
        0,
      ...
      _4_terms_set_with_expected_collateral: [
        TERMS_SET,
        10000,
        100,
        0,
      ...
      _5_terms_set_with_extra_collateral: [
        TERMS_SET,
        10000,
        100,
        0,
      ...
      _6_active_with_escrow_with_more_collateral_required: [
        ACTIVE,
        10000,
        100,
        5000,
      ...
      _7_active_with_escrow_with_expected_collateral: [
        ACTIVE,
        10000,
        100,
        10000,
      ...
      _8_active_with_escrow_with_extra_collateral: [
        ACTIVE,
        10000,
        100,
        10000,
      ...
      _9_active_with_no_escrow_with_more_collateral_required: [
        ACTIVE,
        10000,
        100,
        0,
      ...
      _10_active_with_no_escrow_with_expected_collateral: [
        ACTIVE,
        10000,
        100,
        0,
      ...
      _11_active_with_no_escrow_with_extra_collateral: [
        ACTIVE,
        10000,
        100,
        0,
      ...
      _12_active_with_escrow_value_low: [
        ACTIVE,
        10000,
        100,
        1000,
    ...
    function (
      ...
      it(
        t(
          'user',
          'getCollateralInfo',
          'Should able to get collateral info from a loan.',
          false
        ),
        async function () {
          // Setup
          ...
          const interestRatio = new BigNumber(interestRate)
            .multipliedBy(loanTerms.duration)
            .div(ONE_YEAR);
          const interestOwed = new BigNumber(loanAmount)
          ...
          switch (status) {
            ...
            case ACTIVE:
              ...
              if (escrowValue > 0) {
                collateralNeededInTokens = collateralNeededInTokens.plus(
                  collateralNeededInTokens.minus(escrowValue)
                );
              }
          ...
          const neededInCollateralTokensValueForCalldata = aggregator.contract.methods
            .valueFor(
              lendingToken.address,
              ETH_ADDRESS,
          ...
          const collateralInLendingTokensValueForCalldata = aggregator.contract.methods
            .valueFor(ETH_ADDRESS, lendingToken.address, collateralAmount.toString())
            .encodeABI();
          ...
          // Assertions
          assert.equal(
            collateralResult.toString(),
            collateralAmount.toString(),
            'Collateral does not match'
          );
          assert.equal(
            neededInLendingTokensResult.toString(),
            collateralNeededInTokens.toString(),
            'Lending tokens not match'
          );
          assert(
            moreCollateralRequiredResult === expectedMoreCollateralRequired,
            'Expected result not match'
          );
        }
      );
    }
