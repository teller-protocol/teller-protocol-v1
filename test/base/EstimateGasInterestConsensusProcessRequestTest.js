...
contract('EstimateGasInterestConsensusProcessRequestTest', function (accounts) {
  ...
  let responseThree = createUnsignedInterestResponse(
    nodeThree,
    0,
    34632,
    1,
  ...
  let responseSeven = createUnsignedInterestResponse(
    nodeSeven,
    0,
    34636,
    1,
  ...
  let responseEight = createUnsignedInterestResponse(
    nodeEight,
    0,
    34636,
    1,
  ...
  before('Setup the response times and signatures', async () => {
    ...
    responseSix = await createInterestResponseSig(
      web3,
      nodeSix,
      responseSix,
      requestHash,
    ...
    responseSeven = await createInterestResponseSig(
      web3,
      nodeSeven,
      responseSeven,
      requestHash,
    ...
    responseEight = await createInterestResponseSig(
      web3,
      nodeEight,
      responseEight,
      requestHash,
    ...
    responseNine = await createInterestResponseSig(
      web3,
      nodeNine,
      responseNine,
      requestHash,
