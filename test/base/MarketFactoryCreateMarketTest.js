  ...
  withData(
    {
      ...
      _6_borrowed_token_not_ccontract: [
        0,
        false,
        2,
        99,
    ...
    function (
      ...
      it(
        t(
          'user',
          'createMarket',
          'Should able (or not) to create a market correctly.',
          mustFail
        ),
        async function () {
          // Setup
          ...
          const collateralTokenAddress =
            collateralTokenIndex === 100
              ? ETH_ADDRESS
              : getInstance(mocks, collateralTokenIndex, 4);
          ...
          try {
            ...
            const newMarket = await instance.getMarket(
              borrowedTokenAddress,
              collateralTokenAddress
            );
