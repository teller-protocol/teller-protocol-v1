...
contract('SettingsGetAndHasPlatformSettingTest', function (accounts) {
  ...
  withData(
    {
      _1_maximumLoanDuration: [
        settingsNames.MaximumLoanDuration,
        newSetting(1000, 0, 1001),
      ],
      ...
      _4_requiredSubmissionsPercentage: [
        settingsNames.RequiredSubmissionsPercentage,
        newSetting(8000, 0, 10000),
      ],
      _5_responseExpiryLength: [
        settingsNames.ResponseExpiryLength,
        newSetting(735, 0, 9000),
      ],
      _6_termsExpiryTime: [settingsNames.TermsExpiryTime, newSetting(2225, 0, 20000)],
      _7_liquidateEthPrice: [
        settingsNames.LiquidateEthPrice,
        newSetting(9325, 9324, 10000),
      ],
    ...
    function (settingKey, currentValue) {
      it(
        t(
          'user',
          `getPlatformSetting`,
          `Should be able to get the current platform setting (${settingKey}) value.`,
          false
        ),
        async function () {
          // Setup
