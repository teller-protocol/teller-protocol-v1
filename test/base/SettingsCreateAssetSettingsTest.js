  ...
  withData(
    {
      ...
      _2_asset_empty: [
        ...
        99,
        2000,
        'ASSET_ADDRESS_MUST_BE_CONTRACT',
        true,
      ],
      _3_asset_not_contract: [
        false,
        1,
        true,
        2,
  ...
  withData(
    {
      _1_valid_owner: [
        ...
        false,
        0,
        { useCurrentSetting: false, index: 99 },
        99,
        10000,
        undefined,
        false,
      ...
      _6_invalid_max_loan_amount_zero: [
        [],
        false,
        0,
        { useCurrentSetting: false, index: 99 },
      ...
      _7_invalid_asset_already_exist: [
        ...
        false,
        0,
        { useCurrentSetting: true, index: 1 },
        99,
        2100,
        'ASSET_SETTINGS_ALREADY_EXISTS',
        true,
      ],
    },
    function (
      ...
      it(
        ...
        async function () {
          ...
          try {
            ...
            assert.equal(
              assetSettingsResult.cTokenAddress.toString(),
              cTokenAddress.toString()
            );
            assert.equal(
              assetSettingsResult.maxLoanAmount.toString(),
