...
contract('SettingsCreateAssetSettingsTest', function (accounts) {
    ...
    withData({
        ...
        it(t('user', 'createAssetSettings', 'Should (or not) be able to create a new asset instance.', mustFail), async function() {
            // Setup
    ...
    withData({
        ...
        it(t('user', 'createAssetSettings#2', 'Should (or not) be able to create a new asset instance.', mustFail), async function() {
            ...
            const assetAddress = useCurrentSetting ? currentAssetsInfo[assetAddressIndex].assetAddress : getContractAddress(assetAddressIndex, assetInstance);
            const cTokenAddress = getContractAddress(cTokenAddressIndex, cTokenInstance);
