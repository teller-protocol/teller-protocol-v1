...
contract('SettingsCreatePlatformSettingTest', function (accounts) {
  ...
  const newSetting = (name, value, min = 0, max = value * 2) => ({
    name,
    nameBytes32: toBytes32(web3, name),
    value,
    min,
    max,
  });
  ...
  withData(
    {
      _1_valid: [
        ...
        0,
        newSetting('mySetting', 1000, 0, 9000),
        undefined,
        false,
      ],
      _2_invalid_value_lt_min: [
        [],
        0,
        newSetting('mySetting', 1000, 1001, 9000),
        'VALUE_MUST_BE_GTE_MIN_VALUE',
        true,
      ],
      _3_valid_value_equal_min: [
        [],
        0,
        newSetting('mySetting', 1000, 1000, 9000),
        undefined,
        false,
      ],
      _4_invalid_value_gt_max: [
        [],
        0,
        newSetting('mySetting', 8501, 1000, 8500),
        'VALUE_MUST_BE_LTE_MAX_VALUE',
        true,
      ],
      _5_valid_value_equal_max: [
        [],
        0,
        newSetting('mySetting', 6000, 1000, 6000),
        undefined,
        false,
      ],
      _6_invalid_already_exist: [
        ...
        0,
        newSetting('customSetting5', 1000, 0, 9000),
        'PLATFORM_SETTING_ALREADY_EXISTS',
        true,
      ],
      _7_invalid_not_owner: [
        ...
        1,
        newSetting('customSetting9', 1000, 0, 9000),
        'NOT_PAUSER',
        true,
      ],
      _8_valid_max_value: [
        [],
        0,
        newSetting('myCustomSettingA', 9000, 0, MAX_VALUE_STRING),
        undefined,
        false,
      ],
      _9_invalid_max_value_overflow_uint256: [
        [],
        0,
        newSetting('myCustomSettingB', 9000, 0, MAX_VALUE.plus(1)),
        'VALUE_MUST_BE_LTE_MAX_VALUE',
        true,
      ],
      _10_invalid_min_value_underflow_uint256: [
        [],
        0,
        newSetting('myCustomSettingC', 9000, -1, 10000),
        'VALUE_MUST_BE_GTE_MIN_VALUE',
        true,
      ],
      _11_invalid_empty_name: [
        [],
        0,
        newSetting('', 1000, 1001, 9000),
        'SETTING_NAME_MUST_BE_PROVIDED',
        true,
      ],
    },
    function (previousSettings, senderIndex, newValue, expectedErrorMessage, mustFail) {
      it(
        t(
          ...
          `Should (or not) be able to create a platform setting.`,
          mustFail
        ),
        async function () {
          // Setup
          ...
          try {
            ...
            assert.equal(
              platformSettingResult.value.toString(),
