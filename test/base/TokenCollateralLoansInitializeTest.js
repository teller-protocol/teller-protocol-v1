...
contract('TokenCollateralLoansInitializeTest', function (accounts) {
    ...
    withData({
        ...
        _3_not_lendingpool: [2, -1, 4, 5, 6, 7, 'PROVIDE_LENDINGPOOL_ADDRESS', true],
        ...
        _7_not_markets: [2, 3, 4, 5, 6, -1, 'MARKETS_MUST_BE_PROVIDED', true],
        _8_not_contract_markets: [2, 3, 4, 5, 6, 99, 'MARKETS_MUST_BE_A_CONTRACT', true],
    }, function(
        priceOracleIndex,
        lendingPoolIndex,
