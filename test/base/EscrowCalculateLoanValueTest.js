  ...
  withData(
    {
      ...
      _2_1_token_and_eth: [
        [
          { isToken: true, amount: 1000 },
          { isToken: false, amount: 2000 },
        ],
        3000,
      ],
      _3_3_tokens: [
        [
          { isToken: true, amount: 1000 },
          { isToken: true, amount: 2000 },
          { isToken: true, amount: 3000 },
        ],
        6000,
      ],
      _4_3_tokens_and_eth: [
        [
          ...
          { isToken: true, amount: 2000 },
          { isToken: true, amount: 3000 },
          { isToken: false, amount: 4000 },
        ],
        10000,
      ],
    },
    function (tokenAmounts, expectedValue) {
      it(
        t(
          'escrow',
          'calculateTotalValue',
