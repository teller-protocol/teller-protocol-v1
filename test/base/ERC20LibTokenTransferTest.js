...
contract('ERC20LibTokenTransferTest', function (accounts) {
    ...
    withData({
        ...
        it(t('user', 'tokenTransfer', 'Should able (or not) to transfer tokens.', mustFail), async function() {
            // Setup
            ...
            try {
                ...
                assert.equal(
                    BigNumber(initialBalanceWithDecimals.toString()).minus(finalBalanceWithDecimals.toString()).toFixed(0),
    ...
    withData({
        ...
        it(t('user', 'tokenTransfer#2', 'Should able (or not) to transfer tokens.', mustFail), async function() {
            // Setup
