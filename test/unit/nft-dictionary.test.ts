...
describe.only('TellerNFTDictionary', () => {
  ...
  it('Should deploy the dictionary', async () => {
    ...
    it('Should add tier data', async () => {
      ...
      await dictionaryContract.setTier(0, Tier0, {
        from: await signerAccount.getAddress(),
      })
      await dictionaryContract.setTier(1, Tier1, {
        from: await signerAccount.getAddress(),
      })
      await dictionaryContract.setTier(2, Tier2, {
        from: await signerAccount.getAddress(),
      })
      ...
      const tokenContributionSize =
        await dictionaryContract.tokenContributionSize('0')
