import { NFTMerkleTree, TierInfo } from '../types/custom/config-types'
import mainnetNFTMerkle from './merkleTrees/mainnet.json'
import testnetNFTMerkle from './merkleTrees/testnet.json'
