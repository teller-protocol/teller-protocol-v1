...
const registerLogicVersions: DeployFunction = async (hre) => {
  ...
  const logicNames = [
    {
      ...
      logicName: ethers.utils.id('ChainlinkPairAggregator'),
    },
    { identifier: 'TToken_Logic', logicName: ethers.utils.id('TToken') },
    {
      identifier: 'EtherCollateralLoans_Logic',
      logicName: ethers.utils.id('EtherCollateralLoans'),
    },
    {
      identifier: 'TokenCollateralLoans_Logic',
      logicName: ethers.utils.id('TokenCollateralLoans'),
    },
    {
      identifier: 'LendingPool_Logic',
      logicName: ethers.utils.id('LendingPool'),
    },
    {
      identifier: 'LoanTermsConsensus_Logic',
      logicName: ethers.utils.id('LoanTermsConsensus'),
    },
    {
      identifier: 'EscrowFactory_Logic',
      logicName: ethers.utils.id('EscrowFactory'),
    },
    {
      identifier: 'MarketFactory_Logic',
      logicName: ethers.utils.id('MarketFactory'),
    },
    ...
    { identifier: 'Compound_Logic', logicName: ethers.utils.id('Compound') },
    {
      ...
      logicName: ethers.utils.id('AssetSettings'),
    },
  ]
  ...
  const versionsRegistry = await contracts.get<LogicVersionsRegistry>(
